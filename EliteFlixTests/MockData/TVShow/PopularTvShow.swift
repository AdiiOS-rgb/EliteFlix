...
let popularTvShowsData = """
{
    ...
    "results": [
        ...
        },
        {
            ...
            "overview": "Bob's Burgers follows a third-generation restaurateur, Bob, as he runs Bob's Burgers with the help of his wife and their three kids. Bob and his quirky family have big ideas about burgers, but fall short on service and sophistication. Despite the greasy counters, lousy location and a dearth of customers, Bob and his family are determined to make Bob's Burgers a success.",
            "popularity": 990.064,
...
let popularTvShowsResponse = try? JSONDecoder().decode(PopularTVShowsList.self, from: popularTvShowsData!)

//func getTopRatedTV() -> PopularTVShowsList? {
//    let response: PopularTVShowsList?
//    do {
//        guard let data = popularTvShowsData else {
//            print("nil returned data \n\n")
//            return nil
//        }
//        response =  try JSONDecoder().decode(PopularTVShowsList.self, from: data)
//    } catch(let error){
